...
#include </home/coglab/Documents/Retina/TemporalExp_retina/retina.h>
//#include "retina.h"
...
#define VALUE 0
#if VALUE == 1
#define retthresh   249.168//249.168 //249.624 //247.96
#define gama	0.13//1.15
#define beta	16.0
#define alpha	0.4//1.8
#define Jval	12.0
#define persistence 0.035
#else
#define retthresh   249.168//249.168 //249.624 //247.96
#define gama	0.13//1.15
#define beta	16.0
...
static int Problem1(void)
{
  ...
  // To simulate the data in Yeshurum Exp3
  //char root[100] = "/home/coglab/Documents/Results/Retina_p3/TemporalExp3/isi2/Neutral/";
  char root[100] = "/home/coglab/Documents/Results/Retina_p3/TemporalExp3/isi2/Attention/";
// To simulate the data in Yeshurum Exp4
  //char root[100] = "/home/coglab/Documents/Results/Retina_p3/TemporalExp4/isi2/Neutral/";
  //char root[100] = "/home/coglab/Documents/Results/Retina_p3/TemporalExp4/isi2/Attention/";
...
/*************************** Xon per equation ************************/
	...
	//NV_Ith_S(ydot,i+xon)=0.055*(-1*NV_Ith_S(y,i+xon)+retcor(NV_Ith_S(y,i+Zcelly)));
...
realtype t;
{
    if ((i > 270 && i < 275 && t > 1 && t < 47) || (i > 270 && i < 275 && t > (47+ISI) && t < (2*47+ISI))) // The origial spatial values are [270 310] and for the Exp3 were reduced to [270 275]
    {
        return((10)*Intensity + 1*L0);  // if you increase the pulse amplitude to a certain thershold the output will be negative due to the concalib function
        //return(0.0);
        }
    else
        return(L0);
...
double a;
{
	if(a < 586.16) // ORIGINAL = 587 gap1= 586.58; gap2= 587.52; gap3= 587.09; Exp3 = 586.16
		{
		return(0.0);
		}
	return(a-586.16); // a-587
}
